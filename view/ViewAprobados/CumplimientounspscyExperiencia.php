                            ...
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <?php for ($i=0; $i <sizeof($vectorcito) ; $i++) {  
                                        echo "<tr>";
                                                ...
                                                echo "<td>";
                                                ?>                                            
                                                <!-- <a href="<?php /* echo ABS_PATH."revision/viewExperiences/".$vectorcito[$i][8]."/".$vectorcito[$i][9]; */?>" class="btn btn-link"><span style="font-size: 3em; color: orange;"><i class="mdi mdi-certificate"></i></span></a> -->
                                                <a href="<?php echo ABS_PATH."revision/SeeExperience/".$vectorcito[$i][8]."/".$vectorcito[$i][9]; ?>" class="btn btn-link"><span style="font-size: 3em; color: orange;"><i class="mdi mdi-certificate"></i></span></a>
                                                <td>
